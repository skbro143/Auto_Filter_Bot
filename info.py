...
# ============================
SESSION = environ.get('SESSION', 'Sk_bro')   # Session name for the bot
API_ID = int(environ.get('API_ID', '23416113')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '5f66046e7129c9bf6e2b3da943ae2993')  # API Hash from my.telegram.org
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6662808885 1289890372').split()] # Replace with the actual admin ID(s) to add
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003193393301'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002420970943').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002678239309')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002250676177 -1003166989741')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+dOjDaXA2hFczZjg9')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002250676177 -1003166989741")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-100")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/XfQMtP6L/photo-2025-07-03-14-04-41-7522856371105038356.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'sudeep9743232@axl')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vinod974323_db_user:PtlsOaL4IusWnJ1D@cluster0.jlfgwbv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://vinod974323_db_user:Xs4KBtvo8Rns5gF5@cluster0.lyml7nb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002739334108'))  # Notification of sent to your channel
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_To_Open_Link_06")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "d200e6d92af0bf242b9d25fce8c9b7023bb7720e") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "linkshortify.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "d200e6d92af0bf242b9d25fce8c9b7023bb7720e")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "linkshortify.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "d200e6d92af0bf242b9d25fce8c9b7023bb7720e")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+dOjDaXA2hFczZjg9') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/SkHelpq_bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/SK_MOVIESZ') # Update channel link for the bot
